    ...
    <>
      <div className='mt-5'>
        ...
        <div className='prose'>
          ...
          <p className='mb-2 justify-start text-base'>
            Then, i change my job to software engineer included game developer,
            web developer and mobile developer as freelancer, also full-time
            employee in company called{' '}
            <UnderlineLink
        ...
        <div className='mb-3 flex flex-row justify-between'>
          <div>
            ...
            <ul className='ml-6 mt-1 list-disc text-sm font-semibold'>
              <li>Python, NodeJS, VueJS, MongoDB, Android, iOS, App Engine.</li>
            </ul>
          </div>
